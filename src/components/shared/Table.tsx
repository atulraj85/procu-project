...
const Table: React.FC<TableProps> = ({ title, titles, content }) => {
  ...
  //   const t = titles.map((title: any) => title.header);
  ...
  return (
    <div className="w-full px-10">
      ...
      <div className="flex space-x-5 text-black items-center text-xl">
        <h1>Download</h1>
        <button
          onClick={exportToExcel}
          className="bg-green-700 hover:bg-green-400 border py-1 px-5  text-white text-base my-5"
        >
          .xlsx
        </button>
        {/* <button
