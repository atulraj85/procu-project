...
const ProductDetails = () => {
  ...
  const calculateTotalProductPrice = () => {
    return products.reduce((acc, product) => {
      ...
      const gst = Number(product.gst) / 100;
  ...
  const validate = () => {
    ...
    if (Number(productData.gst) > 100) {
      toast.error("GST Should be equal or less than 100");
      count++;
    }
    ...
    <div className="text-gray-800 text-xl">
      ...
      <div className="flex items-end mt-4">
        ...
        <input
          ...
          name="amount"
          value={otherCharges}
          onChange={(e: any) => setOtherCharges(e.target.value)}
          className="outline-none border-b-2 border-gray-600"
          placeholder="Amount"
        />
